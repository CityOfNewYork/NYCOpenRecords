...
class RequestViewsTests(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.anonymous_user = create_user()
    ...
    def test_view_all_agency(self, render_template_patch, search_request_form_patch):
        """
        ...
        :param search_request_form_patch: patch SearchRequestsForm form object from request.views
        """
        # login agency_user
        with self.client as client:
            ...
            render_template_patch.assert_called_once_with(
                'request/all.html',
                form=search_request_form_patch(),
    ...
    def test_view_all_anon(self, render_template_patch, search_request_form_patch):
        """
