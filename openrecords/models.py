...
class Permission:
    ...
    VIEW_REQUEST_INFO_ALL = 0x00016
    ADD_NOTE = 0x00032
    UPLOAD_DOCUMENTS = 0x00064
    VIEW_DOCUMENTS_IMMEDIATELY = 0x00128
    VIEW_REQUESTS_HELPER = 0x00256
    VIEW_REQUESTS_AGENCY = 0x00512
    VIEW_REQUESTS_ALL = 0x01024
    EXTEND_REQUESTS = 0x02048
    CLOSE_REQUESTS = 0x04096
    ADD_HELPERS = 0x08192
    REMOVE_HELPERS = 0x16384
    ACKNOWLEDGE = 0x32768
    CHANGE_REQUEST_POC = 0x65536
    ADMINISTER = 0x80000
