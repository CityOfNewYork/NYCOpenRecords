...
def upgrade():
    ...
    # sa.Column('type', sa.Enum('acknowledgment', 're-opening', 'closing', 'denial', 're-opening', name='letter_type'), nullable=False),
    ...
    op.execute("ALTER TABLE letter_templates ADD type determination_type;")
