...
Revision ID: 8a3dd47a77ff
Revises: None
Create Date: 2016-12-12 13:27:09.535651

"""

# revision identifiers, used by Alembic.
revision = '8a3dd47a77ff'
down_revision = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('dtype', sa.Enum('denial', 'acknowledgment', 'extension', 'closing', 're-opening', name='determination_type'), nullable=False),
    ...
    sa.Column('auth_user_type', sa.Enum('Saml2In:NYC Employees', 'FacebookSSO', 'MSLiveSSO', 'YahooSSO', 'LinkedInSSO', 'GoogleSSO', 'EDIRSSO', 'AnonymousUser', name='auth_user_type'), nullable=True),
