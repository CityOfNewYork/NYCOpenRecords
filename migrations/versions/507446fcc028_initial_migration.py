...
def upgrade():
    ...
    op.create_table('requests',
                    ...
                    sa.Column('submission', sa.Enum('Direct Input', 'Fax', 'Phone', 'Email', 'Mail', 'In-Person', '311',
                                                    name='submission'), nullable=True),
                    sa.Column('status', sa.Enum('Open', 'In Progress', 'Due Soon', 'Overdue', 'Closed', name='status'),
                              nullable=False),
    ...
    op.create_table('responses',
                    ...
                    sa.Column('privacy', sa.Enum('private', 'release_private', 'release_public', name='privacy'),
                              nullable=True),
                    sa.Column('date_modified', sa.DateTime(), nullable=True),
                    sa.Column('release_date', sa.DateTime(), nullable=True),
                    sa.Column('deleted', sa.Boolean(), nullable=False),
                    sa.Column('type', sa.Enum('notes', 'links', 'files', 'instructions', 'determinations', 'emails',
    ...
    op.create_table('determinations',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('dtype', sa.Enum('denial', 'acknowledgment', 'extension', 'closing', 're-opening',
                                               name='determination_type'), nullable=False),
