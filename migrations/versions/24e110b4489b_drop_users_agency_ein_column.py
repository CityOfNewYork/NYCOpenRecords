...
def downgrade():
    op.add_column('users', sa.Column('is_agency_admin', sa.BOOLEAN(), autoincrement=False, nullable=False))
    op.add_column('users', sa.Column('is_agency_active', sa.BOOLEAN(), autoincrement=False, nullable=False))
