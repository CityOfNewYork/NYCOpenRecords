...
def get_due_date(date_submitted, days_until_due, hour_due=21, minute_due=0, second_due=0):
    """
    ...
    :param hour_due: Hour when the request will be marked as overdue, defaults to 2100 (5 P.M. New York)
    ...
    calc_due_date = calendar.addbusdays(date_submitted, days_until_due)
    return calc_due_date.replace(hour=hour_due, minute=minute_due, second=second_due)
