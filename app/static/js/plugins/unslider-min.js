!function ($) {
    return $ ? ($.Unslider = function (t, n) {
        ...
        return e._ = "unslider", e.defaults = {
            ...
            nav: !0,
            arrows: {
                prev: '<a class="' + e._ + '-arrow prev btn btn-default"><span id="prev" class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span></a>',
                next: '<a class="' + e._ + '-arrow next btn btn-default"><span id="next" class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>'
            },
