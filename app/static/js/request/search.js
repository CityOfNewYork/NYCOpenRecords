...
$(function () {
    ...
    function buildResultsTable(theResults, count, total) {
        ...
        theTable = theTable + '<div class="alert alert-info col-md-12" tabindex="0"><strong>*</strong> - "Under Review" means the request was recently submitted and the agency has 5 business days to review the request for personal identifying information.</div>';
