    ...
    $(document).ready(function () {
        ...
        $("#request-category").change(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    getRequestAgencyInstructions();
                    $(".appended-div")
                .remove(); // remove the appended divs from previous agency
                    previousValues = [];
                    currentValues = [];
        ...
        $("#custom-request-form-additional-content").click(function () {
            ...
            var dropdownTemplate =
                "<div class='panel panel-default appended-div' id='custom-request-panel-" +
                customRequestFormCounter + "'><div class='panel-heading' id='custom-request-forms-" +
                customRequestFormCounter +
                "' style='display: block;'><label class='request-heading request-type-label' for='request-type-" +
                customRequestFormCounter +
                "'>Request Type (optional)</label><button type='button' class='close panel-dismiss' id='panel-dismiss-button-" +
                customRequestFormCounter +
                "' data-target='#panel-dismiss-modal' data-toggle='modal'><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></button><select class='input-block-level request-type' id='request-type-" +
                customRequestFormCounter +
                "' name='request_type' aria-label='Request type, required, please select the option that best describes the records you are requesting'></select><br></div>";
            var contentTemplate = "<div class='panel-body' id='custom-request-form-content-" +
                customRequestFormCounter + "' hidden></div></div>";
            $(dropdownTemplate + contentTemplate).insertBefore(
                "#custom-request-form-additional-content");
        ...
        var requiredFields = ["request-title", "request-description", "request-agency", "first-name",
            "last-name", "email",
