...
echo "searchguard.ssl.transport.keystore_filepath: /etc/elasticsearch/keystore.jks" | $SUDO_CMD tee -a  $ES_CONF_FILE > /dev/null
echo "searchguard.ssl.transport.truststore_filepath: /etc/elasticsearch/truststore.jks" | $SUDO_CMD tee -a $ES_CONF_FILE > /dev/null
...
echo "searchguard.ssl.http.keystore_filepath: /etc/elasticsearch/keystore.jks" | $SUDO_CMD tee -a $ES_CONF_FILE > /dev/null
echo "searchguard.ssl.http.truststore_filepath: /etc/elasticsearch/truststore.jks" | $SUDO_CMD tee -a $ES_CONF_FILE > /dev/null
